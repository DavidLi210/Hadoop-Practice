...
public class Question3 {
    // this class implements question2 and question3
...
//            if (!has) {
    ...
    public static class BussMapper extends Mapper<Object, Text, Text, Text> {
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            String[] split = value.toString().split("::");
            if (split.length != 3) {
                // this record is in a wrong format, discard it
...
//        System.exit(job2.waitForCompletion(true) ? 0 : 1);
        ...
        MultipleInputs.addInputPath(job3, new Path(bussinessPath), TextInputFormat.class, BussMapper.class);
        MultipleInputs.addInputPath(job3, new Path(outputPath + "/sort/part-*"), TextInputFormat.class, TopMapper.class);
